            ...
            <div className="bg-white/80 backdrop-blur-md px-8 py-5 shadow-[0_1px_24px_rgba(0,0,0,0.05)] border-b border-blue-50/50 flex items-center justify-between z-20">
                <div className="flex items-center gap-6">
                    ...
                    {undoStack.length > 0 && (
                        <div className="flex items-center gap-2 animate-in fade-in slide-in-from-left-4 duration-500">
                            ...
                            <button
                                onClick={handleUndo}
                                className="flex items-center gap-2 px-4 py-2 text-[11px] font-black text-white bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-lg shadow-indigo-200 transition-all active:scale-95 uppercase tracking-wider relative overflow-hidden group/undo"
                            >
                                <RotateCcw size={14} strokeWidth={3} className="group-hover/undo:-rotate-45 transition-transform" />
                                Fortryd ({undoStack.length})
                            </button>
                        </div>
                    )}
                </div>
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-blue-600 hover:bg-blue-50 rounded-xl transition-all active:scale-95"
                    >
                        <Target size={16} />
                        I dag
                    </button>
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 bg-linear-to-r from-blue-600 to-blue-500 text-white px-7 py-3 rounded-[20px] font-black shadow-[0_8px_20px_-4px_rgba(37,99,235,0.4)] hover:shadow-[0_12px_24px_-4px_rgba(37,99,235,0.5)] hover:-translate-y-0.5 active:translate-y-0 transition-all"
                    >
                        ...
                        {isLoading ? (
                            <div className="absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm z-50">
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Henter aktiviteter...</p>
                                </div>
                            </div>
                        ) : (
                            <Timeline
