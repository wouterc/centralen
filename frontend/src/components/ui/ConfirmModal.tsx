            ...
            <div className="relative z-10 bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] transform transition-all sm:max-w-lg w-full border border-gray-100 overflow-hidden animate-in fade-in zoom-in duration-200">
                <div className="bg-white px-6 pt-6 pb-4 sm:p-8 sm:pb-6">
                    <div className="sm:flex sm:items-start">
                        <div className={`mx-auto flex-shrink-0 flex items-center justify-center h-14 w-14 rounded-2xl ${isDestructive ? 'bg-red-50' : 'bg-blue-50'} sm:mx-0 sm:h-12 sm:w-12 shadow-sm`}>
                ...
                <div className="bg-gray-50/100 px-6 py-4 sm:px-8 sm:flex sm:flex-row-reverse gap-3 border-t border-gray-100">
                    <Button
