...
import { OpgavePriority } from '../../types';
...
}> = ({ opgave, onClick, users, onAssigneeChange, innerRef, style, attributes, listeners, isOver, isOverArchive }) => {
        ...
        >
            ...
            <div className="grid grid-cols-3 items-center pt-1.5 mt-0">
                ...
                >
                        ...
                        {opgave.ansvarlige_details && opgave.ansvarlige_details.length > 0 ? (
                            opgave.ansvarlige_details.map((user) => (
                                <div
                                    ...
                                    title={user.first_name || user.last_name ? `${user.first_name} ${user.last_name}`.trim() : user.username}
                    ...
                    {showAssigneeSelector && users && onAssigneeChange && createPortal(
                        ...
                        >
                            ...
                            <div className="p-1">
                                {users
                                    .filter(u => !opgave.team || (u.teams && u.teams.some(t => t.id === opgave.team)))
                                    ...
                                    .map(user => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="w-4 h-4 rounded border border-gray-300 flex items-center justify-center bg-white group/check">
                ...
                <div className="flex flex-col items-center justify-center">
                    {opgave.team_details && (
                        <span className="text-[8px] font-black text-blue-500 uppercase tracking-tighter bg-blue-50 px-1 rounded border border-blue-100 mb-0.5">
                            {opgave.team_details.navn}
                        </span>
                    )}
